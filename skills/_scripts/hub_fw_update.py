...
def main(argv=None):
    ...
    p.add_argument("--rssi-floor", type=int, default=RSSI_FLOOR_DEFAULT,
                   help=f"skip a DIRECT, MEASURED node with lwrRssi <= this dBm (default {RSSI_FLOOR_DEFAULT}); hang-prone. Routed and unmeasured links skip regardless — see --flash-unmeasured")
